...
public class GusListModel {
	...
	public static List<PostData> dataList;
	
	public GusListModel() {
		dataList = new ArrayList<PostData>();
		dataList.add(new PostData("bike", "Schwinn 10 speed - almost new!", 50.0,
				 new Seller("Joe Cool"), new Buyer("Jill Cool")));
		dataList.add(new PostData("book", "Moby Dick - a classic!", 2.0,
